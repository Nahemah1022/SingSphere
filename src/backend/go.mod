module github.com/Nahemah1022/singsphere-backend
...
require (
	...
	github.com/pion/sdp/v2 v2.3.4 // indirect
	github.com/pion/srtp v1.2.7 // indirect
	github.com/pion/stun v0.3.3 // indirect
